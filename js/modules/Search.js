            ...
            this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.institutions.length ? '<ul class="link-list min-list">' : `<p>No institutions match that search. <a href="${universityData.root_url}/institutions">View all institutions</a></p>`}
                        
                        ${results.institutions.map((item) => `<li><a href="${item.permalink}">${item.title}</a></li>`).join('')} 

                        ${results.institutions.length ? '</ul>' : ''}
...
//===========================================================================
//ADDED SAME CODE BUT JQUERY FREE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//===========================================================================
